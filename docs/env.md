...
## Старый способ(скоро будет деприкейтнут)
...
## Новый способ(не совсем готов)

В данном способе не работает создание проекта через плагин.
По-этому создание проекта происходит только через терминал (cmd)

- перейти в в директорию где хранятся проекты
